    ...
    <div id="#about" className="pb-20 pt-36">
      <div>
        ...
        <Spotlight
          ...
          fill="green"
        />
        <Spotlight className="top-28 left-80 h-[80] w-[50vw]" fill="green" />
      </div>
      <div className="h-screen w-full dark:bg-black bg-black  dark:bg-grid-white/[0.09] bg-grid-black/[0.2] absolute top-0 left-0 flex items-center justify-center">
      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="max-w-[89] md:max-w-2xl lg:max-w-[60] flex flex-col items-center justify-center">
          ...
          <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">
            Hi! I&apos;m Simphiwe, Just a Software Developer
          </p>
          <a href="#projects">
            <MagicButton
              title="Show my work"
